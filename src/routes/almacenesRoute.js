...
router.put('/id/:id', autentificaJWT, AlmacenController.updateAlmacenById); // Actualizar un almacén por ID
router.delete('/id/:id', autentificaJWT, AlmacenController.deleteAlmacenById); // Eliminar un almacén por ID 
